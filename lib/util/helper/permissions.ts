...
export function calculateBasePermissions(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member): bigint {
...
export function calculateCachedChannelOverwrites(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, channelId: bigint, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member): bigint {
...
export function calculateCachedChannelOverwritesForRole(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, channelId: bigint, roleId: bigint): bigint {
  let channel = guild.channels!.get(channelId);
  if (!channel) return 0n;
...
export function getMissingPerms(permissionBits: bigint, permissions: PermissionStrings[]): string[] {
...
/** Checks if the given permission bits are matching the given permissions. `ADMINISTRATOR` always returns `true` */
export function validatePermissions(permissionBits: bigint, permissions: PermissionStrings[]): boolean {
...
export function hasGuildPermissions(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, permissions: PermissionStrings[]): boolean {
...
export function hasChannelPermissions(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, channelId: bigint, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, permissions: PermissionStrings[]): boolean {
...
export function roleHasChannelPermissions(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, channelId: bigint, roleId: bigint, permissions: PermissionStrings[]): boolean {
...
export function missingPermissions<T extends PermissionStrings>(permissionBits: bigint, permissions: T[]): PermissionStrings[] {
  if (permissionBits & 8n) return [];

  return permissions.filter((permission) => !(permissionBits & BigInt(BitwisePermissionFlags[permission])));
}

/** Get the missingtypeof Bootstrap.bot.cache.$inferredTypes.guildpermissions this member has */
export function getMissingGuildPermissions<T extends PermissionStrings>(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, permissions: T[]): PermissionStrings[] {
  // First we need the role permission bits this member has
...
export function getMissingChannelPermissions<T extends PermissionStrings>(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, channelId: bigint, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, permissions: T[]): PermissionStrings[] {
  // First we need the role permission bits this member has
...
export function requireGuildPermissions(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, permissions: PermissionStrings[]): void {
...
/** Throws an error if this member has not all of the given permissions */
export function requireChannelPermissions(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, channelId: bigint, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, permissions: PermissionStrings[]): void {
...
export function calculatePermissions(permissionBits: bigint): string[] {
...
export function highestRole(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member): typeof Bootstrap.bot.cache.$inferredTypes.role | typeof Bootstrap.bot.transformers.$inferredTypes.role | undefined {
  // Get the roles from the member
  const memberRoles = member.roles;
  // This member has no roles so the highest one is the @everyone role
  if (!memberRoles) return guild.roles!.get(guild.id)!;

  let memberHighestRole: typeof Bootstrap.bot.cache.$inferredTypes.role | undefined;
...
export function higherRolePosition(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, roleId: bigint, otherRoleId: bigint): boolean {
  const role = guild.roles!.get(roleId);
...
export function isHigherPosition(guild: typeof Bootstrap.bot.cache.$inferredTypes.guild, member: typeof Bootstrap.bot.cache.$inferredTypes.member | typeof Bootstrap.bot.transformers.$inferredTypes.member, compareRoleId: bigint): boolean {
